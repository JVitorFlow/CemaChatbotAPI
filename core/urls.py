...
from CEMAConnector.views import SubespView, UnidView, EspecialidadeBasica, ConveniosDisponiveis, PlanosDisponiveis, BuscarConvenioView, BuscarPacienteView, CadastrarNovoPaciente, BuscarDataDisponivel, BuscarHorario
...
urlpatterns = [
    ...
    path('api/convenios_disponiveis/', ConveniosDisponiveis.as_view(), name='convenios_disponiveis'),
